...
public class OopsocsamplePersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Oopsocsample";
	...
	private OopsocsamplePersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new OopsocsamplePersistentManager();
		}
